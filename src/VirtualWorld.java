    ...
    public static boolean processLine(String line, WorldModel world,
        ...
        if (properties.length > 0) {
            switch (properties[PROPERTY_KEY]) {
                ...
                case SMITH_KEY:
                    // old: return Entity.parseSmith(properties, world, imageStore);
                    EntityInterface smith = new Blacksmith(properties[1], new Point(Integer.parseInt(properties[2]), Integer.parseInt(properties[3])), imageStore.getImageList(properties[4]));
